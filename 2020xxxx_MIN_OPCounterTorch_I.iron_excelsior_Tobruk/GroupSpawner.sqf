...
if (isServer) then {
_crew1 = creategroup independent;
_airframe1 = [getMarkerPos "ins_1", 210, "sab_corsair", _crew1] call BIS_fnc_spawnVehicle;
_airframe2 = [getMarkerPos "ins_2", 210, "sab_corsair", _crew1] call BIS_fnc_spawnVehicle;
_airframe3 = [getMarkerPos "ins_3", 210, "sab_corsair", _crew1] call BIS_fnc_spawnVehicle;

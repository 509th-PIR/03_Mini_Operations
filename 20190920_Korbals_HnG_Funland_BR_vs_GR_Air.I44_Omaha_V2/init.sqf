SPITFIRE_PYLONS = {
    params["_newVehicle"];
    _newVehicle removeWeapon "4xBrowning_303";
    _newVehicle removeMagazine "4xBrowning_mag_303";
    _newVehicle removeWeapon "7Y_BombLauncher";
    _newVehicle removeMagazine "7y_500lb_uk_mag";
    _newVehicle addWeapon "LIB_4xM2_P39";
    _newVehicle addMagazine "LIB_1000Rnd_M2_P39";
};

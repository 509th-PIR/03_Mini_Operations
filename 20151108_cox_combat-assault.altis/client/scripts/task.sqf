	...
	player createDiaryRecord ["Diary", ["Support vehicles", "Some enemies vehicles go over the map. When they stop, they starting to extend and conquer the square where they are. If they finalize, they will win the square and some adjactents square."]];
	...
	player createDiaryRecord ["Diary", ["Ticket System", "This mission uses a ticket system. Every important moment affects the ticket system and decrease or increase tickets. When this happens, a message appears in the roll message box at the top right of the screen to indicate the number of ticket won or lost. If the ticket number is reduced to 0 then the game is lost"]];

	player createDiaryRecord ["Diary", ["Interface color codes", "Three color codes are used by the interface. Red indicates your health level. Green indicates your fatigue level. Blue indicates your azimuth direction."]];

	player createDiaryRecord ["Diary", ["Map Strategy Movement", "The square system uses by the game requires to play with a great strategy. To know the basics are: the enemies in the game by default appear when players are at 4 square of distance. The area is off when the players are more than four square of enemies from that area. When the area off, and it was not won by the players, they generate new random red square around it."]];
